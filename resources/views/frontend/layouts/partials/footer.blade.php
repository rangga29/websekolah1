<div class="section footer-section">
    <div class="footer-widget-section section-padding">
        <img class="shape-01 animation-rotate" src="frontend/images/shape/shape-9.png" alt="Shape">
        ...
        <img class="shape-02 animation-rotate" src="frontend/images/shape/shape-9.png" alt="Shape">
    </div>
        ...
        <div class="container">
            ...
            <div class="copyright-wrapper">
                <div class="copyright-text">
                    <p>&copy; {{ date('Y') }} <span> Nutras </span> Made with <i class="icofont-heart-alt"></i> by
